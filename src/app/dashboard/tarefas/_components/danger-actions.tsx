...
import { arquivarTarefa, excluirTarefa, type FormState } from "../actions";
...
export function DangerActions({ tarefaId }: { tarefaId: string }) {
  return (
    <section className="border-t border-gray-200 pt-4">
      ...
      <div className="mt-3 flex flex-wrap gap-6">
        ...
        <DangerBlock
          ...
          confirmWord="EXCLUIR"
          description="Remove a tarefa e suas subtarefas."
          tone="red"
